...
(function () {
  ...
  var THEMES = {
     ...
     * porte sa propre garde admin|bureau. « Agenda général » vit dans tronc()
     * (accessible depuis toutes les pages) ; ici marquerCourante() le passe en
     * .active non-cliquable. Le thème n'ajoute donc RIEN au tronc (éviter le
     * doublon d'entrée). */
    'agenda-general': {
